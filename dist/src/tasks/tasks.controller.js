...
let TasksController = class TasksController {
    ...
    findAll(req, page = '1', limit = '20', q, completed) {
        return this.tasksService.findAll(req.user.orgId, Number(page), Number(limit), q, completed === undefined ? undefined : completed === 'true');
    }
    findOne(id, req) {
...
__decorate([
    ...
    __param(4, (0, common_1.Query)('completed')),
    __metadata("design:type", Function),
